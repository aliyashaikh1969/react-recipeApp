...
export const RecipeItem = ({item}) => {
    ...
    <div className='flex flex-col w-80 overflow-hidden p-5 bg-white/75 border-white rounded-2xl shadow-xl gap-5'>
        ...
        className='text-sm p-3 mt-5 px-8 rounded-lg uppercase font-medium tracking-wide inline-block shadow-md bg-black text-center text-white'>recipe details</Link>
        </div>
    </div>
  )
}
